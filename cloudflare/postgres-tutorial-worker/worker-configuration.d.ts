/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3472319240372341726cc6e34323d2c6)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	TRIAL_ENV_VAR: string;
	DATABASE_URL: string;
	DB_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TRIAL_ENV_VAR" | "DATABASE_URL" | "DB_URL" | "DATABASE_CA_CERT" | "DB_USERNAME" | "DB_PASSWORD" | "DB_HOST" | "DB_PORT" | "DB_NAME">> {}
}
